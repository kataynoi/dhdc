...
class ExecuteController extends \yii\web\Controller {
    ...
    public function actionProcessreport() {
        ...
        if ($running->is_running == 'false') {
            ...
            //รายงานแผนไทย-knott
            $this->call("cal_rpt_panth_visit_ratio",'2014');
            $this->call("cal_rpt_panth_visit_ratio",'2015');
            $this->call("cal_rpt_panth_drug_value",'2014');
            $this->call("cal_rpt_panth_drug_value",'2015');
