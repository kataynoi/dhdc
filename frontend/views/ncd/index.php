...
<p>
    <?php
    echo Html::a('5) ผู้ป่วยเบาหวานได้รับการตรวจ HbA1c และควบคุมน้ำตาลได้ดี (ปรับ 20150218)', ['ncd/report5']);
    ?>
</p>
<p>
    <?php
    echo Html::a('6) ผู้เป็นความดันโลหิตสูงความคุมความดันโลหิตได้ดี (ปรับ 20150218)', ['ncd/report6']);
    ?>
</p>
